...
function workerPrompt(packet) {
  ...
  return [
    ...
    '- zoom metadata as a reason for ding/success/funny/dramatic. Zoom metadata may support pop timing, but the caption still needs its own editorial reason for every other family.',
